...
def load_vae_by_name(name):
    ...
    try:
        cfg = Config()
        cfg.from_pyfile("config_my.py")
        path = "/bdata/usrdata/root/monitor_test/selforacle_rebuild/vae_ckpt"
        ...
        # encoder_path = "/home/root/ase22/sao/encoder-track1-MSE-latent2"
        # decoder_path = "/home/root/ase22/sao/decoder-track1-MSE-latent2"
